	...
	var ODNF = (function($, undefined){
		...
		_ODNF.ready = function(callback){
			...
			ODNF.ajax(obj, function(result, req) {
				...
				/* 탭 변경시 */
				$('.odnf-tab-button').click(function() {
					
					ODNF.gridValid(function() {
						
						$('.odnf-tab-button').each(function() {
						...
						ODNF.changeTab(linkId.substring(1));
					});
				});
				...
				$('input.clearable:text').each(function() {
					 $(this)[ODNF.tog(this.value)]('x');
					 
					 $(this).on('mousemove', function( e ){
						 $(this)[ODNF.tog(this.offsetWidth-18 < e.clientX-this.getBoundingClientRect().left)]('onX');
		...
		_ODNF.tog = function(v){return v?'addClass':'removeClass';}
		
		
		_ODNF.alert = function(msg, type){
		...
		_ODNF.Object = {
				 ...
				 * 입력받은 값이 비었는지 체크한다.
				 * 
				 * @function ODNF.Object.isEmpty
				 * @description 입력받은 값이 비었는지 체크한다.
				 * @param {Object|Array|Function|String|Number}
				 *            mixed_var 필수. 대상 객체
				 * @returns {Boolean} 비었을 경우 true 그렇지 않을 경우 false
				 * @example ODNF.Object.isEmpty(null); > true
				 * @example ODNF.Object.isEmpty(undefined); > true
				 * @example ODNF.Object.isEmpty([]); > true
				 * @example ODNF.Object.isEmpty({}); > true
				 * @example ODNF.Object.isEmpty({'aFunc' : function () {
				 *          alert('humpty'); } }); > false
				 */
				 ...
				 * 객체내의 속성명을 배열로 반환한다.
				 * 
				 * @function ODNF.Object.keys
				 * @description 객체내의 속성명을 배열로 반환한다.
				 * @param {Object}
				 *            obj 필수. 대상 객체
				 * @returns {Array} 결과 key배열
				 * @example var obj = {aa : 1, bb : 2}; ODNF.Object.keys(obj); >
				 *          ["aa", "bb"]
				 */
				 ...
				 * 
				 * @function ODNF.Object.values
				 * @description 객체내의 각 속성에 대한 Value값을 배열로 반환한다.
				 * @param {Object}
				 *            obj 필수. 대상 객체
				 * @returns {Array} 속성값의 배열
				 * @example var obj = {aa : 1, bb : 2}; ODNF.Object.values(obj); >
				 *          [1, 2]
				 */
				 ...
				 * @example var obj = {"aa":1, "bb":2}; ODNF.Object.map(obj,
				 ...
				 * 
				 * @function ODNF.Object.toQueryString
				 * @description 객체가 비었는지 체크합니다.
				 * @param {Obejct}
				 ...
				 *          ODNF.Object.toQueryString(obj); > aa=1&bb=2
				 */
				 ...
				 * 객체의 요소와 값을 서로 바꾼다.
				 * 
				 * @function ODNF.Object.traverse
				 * @description 객체 요소의 키와 값을 서로 바꾼다. 키가 값이 되고 값이 키가 되는 새로운 객체를 반환한다.
				 * @param {Obejct}
				 *            obj 대상 객체
				 * @returns {Obejct} 변경된 객체
				 * @example var obj = {aa:5, bb:7, cc:8}; ODNF.Object.traverse(obj); >
				 *          {5: "aa", 7: "bb", 8: "cc"}
				 */
				 ...
				 * 객체 요소의 속성 값을 삭제한다.
				 * 
				 * @function ODNF.Object.remove
				 * @description 객체 요소의 키와 값을 서로 바꾼다. 키가 값이 되고 값이 키가 되는 새로운 객체를 반환한다.
				 * @param {Obejct}
				 *            obj 대상 객체
				 * @returns {Obejct} 변경된 객체
				 * @example var obj = {"aa":1, "bb":2}; ODNF.Object.remove(obj, aa); >
				 *          {"aa":null, "bb":2};
				 */
				 ...
				 * stringify 메서드
				 * 
				 * @function ODNF.Object.stringify
				 ...
				 * @example var obj = {"aa":1, "bb":2}; ODNF.Object.stringify(obj); >
				 *          '{"aa":1, "bb":2}'
				 */
		        stringify: window.JSON ? JSON.stringify : function(val, opts, pad) {
		            ...
		            return (function stringify(val, opts, pad) {
		                ...
		                if ($.isArray(val)) {
		                    ...
		                    return "[" + opts.nr + ODNF.Array.map(val, function(el, i) {
		                ...
		                if (isTypePlainObject(val)) {
		                    if (ODNF.Array.indexOf(cache, val) !== -1) {
		                        return null;
		                    }
		                    if (isTypeEmpty(val)) {
		                        return "{}";
		                    ...
		                    cache.push(val);
		                    objKeys = ODNF.Object.keys(val);
		                    return "{" + opts.nr + ODNF.Array.map(objKeys, function(el, i) {
		...
		_ODNF.Date = {
				 ...
				 * 
				 * @function ODNF.Date.cnvStringToDate
				 * @description String형식의 날짜를 Date형식으로 변환
				 * @param {(String)}
				 * @returns {Date} 날짜결과
				 * @example ODNF.Date.cnvStringToDate("20180101"); > 2018/01/01
				 */
				 ...
				 * 유효한(존재하는) 월(月)인지 체크
				 * 
				 * @function ODNF.Date.isValidMonth
				 * @description 유효한(존재하는) 월(月)인지 체크
				 * @param {(String|Number)}
				 *            mm 월문자열
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isValidMonth("11"); > true
				 */
				 ...
				 *            dd 일
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isValidDay("2017", "08", "08"); > true
				 */
				 ...
				 * 유효한(존재하는) 시(時)인지 체크
				 * 
				 * @function ODNF.Date.isValidHour
				 * @description 유효한(존재하는) 시(時)인지 체크
				 * @param {String}
				 *            hh 시
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isValidHour("12"); > true
				 */
				 ...
				 * 유효한(존재하는) 분(分)인지 체크
				 * 
				 * @function ODNF.Date.isValidMin
				 * @description 유효한(존재하는) 분(分)인지 체크
				 * @param {String}
				 *            mi 분
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isValidMin("59"); > true
				 */
				 ...
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isValidTimeFormat("201708071230"); > true
				 */
				 ...
				 * 
				 * @function ODNF.Date.isValidTime
				 * @description 유효하는(존재하는) Time 인지 체크
				 * @param {String}
				 *            time Time 형식의 String
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isValidTime("201708071230"); > true
				 */
				isValidTime: function(time) {
					...
					if (parseInt(year,10) >= 1900  && ODNF.Date.isValidMonth(month) &&
							ODNF.Date.isValidDay(year,month,day) && ODNF.Date.isValidHour(hour)   &&
							ODNF.Date.isValidMin(min)) {
						return true;
					}
					return false;
				},
				 ...
				 * 
				 * @function ODNF.Date.toTimeObject
				 * @description Time 스트링을 자바스크립트 Date 객체로 변환
				 * @param {String}
				 *            time Time 형식의 String
				 * @returns {Date} Date 객체
				 * @example ODNF.Date.toTimeObject("201708071230");
				 */
				 ...
				 * 
				 * @function ODNF.Date.toTimeString
				 * @description 자바스크립트 Date 객체를 Time 스트링으로 변환
				 * @param {Date}
				 *            date Date객체
				 * @returns {String} time Time 형식 문자열
				 * @example ODNF.Date.toTimeString(new Date()); > "201708071230"
				 */
				 ...
				 * 
				 * @function ODNF.Date.isFutureTime
				 * @description Time이 현재시각 이후(미래)인지 체크
				 * @param {String}
				 *            time Time 형식 문자열
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isFutureTime("209908071230"); > true
				 */
				isFutureTime: function(time) {
					return (ODNF.Date.toTimeObject(time) > new Date());
				},

				/**
				 * Time이 현재시각 이전(과거)인지 체크
				 * 
				 * @function ODNF.Date.isPastTime
				 * @description Time이 현재시각 이전(과거)인지 체크
				 * @param {String}
				 *            time Time 형식 문자열
				 * @returns {Boolean} 체크결과
				 * @example ODNF.Date.isPastTime("109908071230"); > true
				 */
				...
				shiftTime: function(time,y,m,d,h) { // moveTime(time,y,m,d,h)
					...
					return ODNF.Date.toTimeString(date);
				},
				/**
				 * 자바스크립트 Date 객체를 Time 스트링으로 변환하여 앞에서부터 입력된 글자 수 까지 잘라서 반환
				 * 
				 * @function ODNF.Date.getCutCurrentTime
				 * @description 자바스크립트 Date 객체를 Time 스트링으로 변환하여 입력된 글자 수 까지 잘라서 반환
				 * @param {INTEGER}
				 *            cut 자를 글자수
				 * @returns {String} time Time 형식 문자열
				 * @example ODNF.Date.getCutCurrentTime(6); > "201708"
				 */
				getCutCurrentTime: function(cut) {
					var date = ODNF.Date.toTimeString(new Date())
					if(date.length < cut){
						cut = date.length;
					}
				 ...
				 * 
				 * @function ODNF.Date.getMonthInterval
				 ...
				 * @example ODNF.Date.getMonthInterval("201701010000","201710010000"); >
				 *          9
				 */
				getMonthInterval: function(time1,time2) { 
					var date1 = ODNF.Date.toTimeObject(time1);
					var date2 = ODNF.Date.toTimeObject(time2);
				 ...
				 * 두 Time이 며칠 차이나는지 구함
				 * 
				 * @function ODNF.Date.getDayInterval
				 ...
				 * @example ODNF.Date.getDayInterval("201701010000","201710010000"); >
				 *          273
				 */
				 ...
				 * 
				 * @function ODNF.Date.getHourInterval
				 ...
				 * @example ODNF.Date.getHourInterval("201701010000","201710010000"); >
				 *          6552
				 */
				 ...
				 * 
				 * @function ODNF.Date.getMinuteInterval
				 ...
				 *            time2 Time 형식 문자열
				 * @returns {Number} 결과 시간수
				 * @example ODNF.Date.getMinuteInterval("201701010000","201710010010"); 
				 * > 10
				 */
				 ...
				 * 현재 시각을 Time 형식으로 리턴
				 * 
				 * @function ODNF.Date.getCurrentTime
				 * @description 현재 시각을 Time 형식으로 리턴
				 * @returns {String} Time 형식 문자열
				 * @example ODNF.Date.getCurrentTime(); > "201708081010"
				 */
				getCurrentTime: function() {
					return ODNF.Date.toTimeString(new Date());
				},
				/**
				 * 현재 시각에 y년 m월 d일 h시를 더한 날짜를 리턴
				 * 
				 * @function ODNF.Date.getRelativeTime
				 ...
				 *            h 시간
				 * @returns {String} Time 형식 문자열
				 * @example ODNF.Date.getRelativeTime("-1", "1", "0", "0"); >
				 *          "201609081039"
				 */
				getRelativeTime: function(y,m,d,h) {
					return ODNF.Date.shiftTime(ODNF.Date.getCurrentTime(),parseInt(y, 10),parseInt(m, 10),parseInt(d, 10),parseInt(h, 10));
				},
				/**
				 * 현재 年을 YYYY형식으로 리턴
				 * 
				 * @function ODNF.Date.getYear
				 * @description 현재 年을 YYYY형식으로 리턴
				 * @returns {String} 문자열
				 * @example ODNF.Date.getYear(); > "2017"
				 */
				getYear: function() {
					return ODNF.Date.getCurrentTime().substr(0,4);
				},
				/**
				 * 현재 月을 MM형식으로 리턴
				 * 
				 * @function ODNF.Date.getMonth
				 * @description 현재 月을 MM형식으로 리턴
				 * @returns {String} 문자열
				 * @example ODNF.Date.getMonth(); > "08"
				 */
				getMonth: function() {
					return ODNF.Date.getCurrentTime().substr(4,2);
				},
				/**
				 * 현재 日을 DD형식으로 리턴
				 * 
				 * @function ODNF.Date.getDay
				 * @description 현재 月을 MM형식으로 리턴
				 * @returns {String} 문자열
				 * @example ODNF.Date.getDay(); > "08"
				 */
				getDay: function() {
					return ODNF.Date.getCurrentTime().substr(6,2);
				},
				/**
				 * 현재 時를 HH형식으로 리턴
				 * 
				 * @function ODNF.Date.getHour
				 * @description 현재 月을 MM형식으로 리턴
				 * @returns {String} 문자열
				 * @example ODNF.Date.getHour(); > "10"
				 */
				getHour: function() {
					return ODNF.Date.getCurrentTime().substr(8,2);
				},	/**
					 * 현재 요일 리턴
					 * 
					 * @function ODNF.Date.getDayOfWeek
					 * @description 현재 요일 리턴
					 * @returns {String} 문자열
					 * @example ODNF.Date.getDayOfWeek(); > "화"
					 */
				 ...
				 * 휴일여부 체크
				 * 
				 * @function ODNF.Date.isHoliday
				 * @description 휴일여부 체크
				 * @returns {Boolean} 휴일:true, 영업일:false
				 * @example ODNF.Date.isHoliday(); > true
				 */
				isHoliday: function() {
					/* 제약 시간관련 변수 */
					var now=new Date();
		 ...
		 * 문자열 관련 공통 함수
		 * 
		 * @namespace {Object} ODNF.String
		 */
		_ODNF.String = function() {
            ...
            return {
				 ...
				 * isEmpty 메서드
				 * 
				 * @function ODNF.String.isEmpty
				 * @see ODNF.Object.isEmpty
				 * @description 입력받은 인자가 비었는지 검사한다.
				 * @param {Object|Array|Function|String|Number}
				 *            mixed_var 필수. 대상 객체
				 * @returns {Boolean} 비었을 경우 true 그렇지 않을 경우 false
				 * @example ODNF.Number.isEmpty(null); > true
				 * @example ODNF.Number.isEmpty(undefined); > true
				 * @example ODNF.Number.isEmpty([]); > true
				 * @example ODNF.Number.isEmpty({}); > true
				 * @example ODNF.Number.isEmpty({'aFunc' : function () {
				 *          alert('humpty'); } }); > false
				 */
	    			isEmpty: _ODNF.Object.isEmpty,
	            	/**
				 * 공백 제거
				 * 
				 * @function ODNF.String.trim
				 * @description 입력된 문자열의 공백을 제거한다.
				 * @param {String}
				 *            value 공백을 제거할 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.trim("222 555"); > 222555
				 */
                trim: function(value) {
				 ...
				 *            경우 기본값 "0"을 사용한다.
				 * @returns {String} 문자열
				 * @example ODNF.String.lpad(123, 6, "0"); > 000123
				 */
				 ...
				 *            않을 경우 기본값 "0"을 사용한다.
				 * @returns {String} 문자열
				 * @example ODNF.String.rPad(123, 6, "0"); > 123000
				 */
				 ...
				 * 문자열 치환
				 * 
				 * @function ODNF.String.replaceAll
				 ...
				 *            rep 치환할 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.replaceAll("abcdefg", "ab", "hello"); >
				 *          hellocdefg
				 */
				 ...
				 * 바이트 기준 문자 갯수 세기
				 * 
				 * @function ODNF.String.byteLength
				 * @description 바이트기준으로 문자의 갯수를 반환한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {Number} 문자열
				 * @example ODNF.String.byteLength("한글"); > 6
				 * @example ODNF.String.byteLength("abcdef"); > 6
				 */
				 ...
				 * 파일명의 확장자 가져오기
				 * 
				 * @function ODNF.String.getFileExt
				 * @description 입력된 파일경로에서 확장자를 추출하여 반환한다.
				 * @param {String}
				 *            fname 파일경로
				 * @returns {String} 파일확장자
				 * @example ODNF.String.getFileExt("/aaaa/bbbb/abcd.gif"); > gif
				 */
				 ...
				 * 파일명 가져오기
				 * 
				 * @function ODNF.String.getFileName
				 * @description 입력된 파일 경로에서 파일명을 추출하여 반환한다.
				 * @param {String}
				 *            str 파일명
				 * @returns {String} 파일확장자
				 * @example ODNF.String.getFileName("/aaaa/bbbb/abcd.gif"); >
				 *          abcd.gif
				 */
				 ...
				 * @returns {String} 문자열
				 * @example ODNF.String.cut("abcdefhijklmnop", 10, "..."); >
				 *          abcdefhijk...
				 */
				 ...
				 * 바이트기준 문자열 자르기
				 * 
				 * @function ODNF.String.cutByByte
				 ...
				 *            truncation 문자열 끝에 덧붙일 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.cutByByte("한글abcdefghijk", 10, "..."); >
				 *          한글abcd...
				 */
				 ...
				 * 첫글자를 대문자로 변환
				 * 
				 * @function ODNF.String.capitalize
				 * @description 문자열의 첫글자를 대문자로 변환한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.capitalize("abcdefg"); > Abcdefg
				 */
				 ...
				 * 
				 * @function ODNF.String.camelize
				 * @description 하이픈(-) 또는 언더라인(_)를 삭제한 문자열을 반환하며 하이픈 다음에 소문자가 있을
				 *              경우 대문자로 변경한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.camelize("abc-def_ghi"); > abcDefGhi
				 */
				 ...
				 * 언더라인을 하이픈으로 변환
				 * 
				 * @function ODNF.String.dasherize
				 * @description 언더라인(_)을 하이픈(-)으로 변환한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.dasherize("abc_def_ghi"); > abc-def-ghi
				 */
				 ...
				 * 첫글자를 소문자로 변환
				 * 
				 * @function ODNF.String.toFirstLower
				 * @description 문자열의 첫글자를 소문자로 변환한다.
				 * 
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.toFirstLower("ABCDEFG"); > aBCDEFG
				 */
				 ...
				 *            sep 구분자
				 * @returns {String} 문자열
				 * @example ODNF.String.repeat("ABCDEFG", 3, "-"); >
				 ...
				 * 특수 문자를 HTML코드로 변환
				 * 
				 * @function ODNF.String.escapeHTML
				 * @description 특수 문자를 HTML코드로 변환
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.escapeHTML("
				 *          <h2>aaa</h2>
				 *          "); > &lt;h2&gt;aaa&lt;/h2&gt;
				 */
				 ...
				 * 
				 * @function ODNF.String.unescapeHTML
				 * @description escape된 HTML코드를 특수문자로 변환
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.unescapeHTML("&lt;h2&gt;aaa&lt;/h2&gt;"); >
				 *          <h2>aaa</h2>
				 */
				 ...
				 *            other 두번째 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.toggle("aa", "aa", "cc"); > aa
				 * @example ODNF.String.toggle("aa", "bb", "cc"); > cc
				 */
				 ...
				 * 
				 * @function ODNF.String.toEntities
				 * @description 특수문자를 Entity Code(엔티티코드)로 변환
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.toEntities("@#$"); > &#64;&#35;&#36;
				 */
				 ...
				 * 랜덤 문자열 생성
				 * 
				 * @function ODNF.String.random
				 * @description 입력받은 길이 만큼의 랜덤 문자열을 생성하여 반환한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.random(10); > 4x4r9tq28k
				 */
                random: function(len) {
                    var keystr = "", x;
                    for (var i = 0; i < len; i++) {
				 ...
				 * HTML태그 제거
				 * 
				 * @function ODNF.String.stripTags
				 * @description 대상문자열에서 HTML태그를 제거한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.stripTags('<div>aaa
				 *          <h2>bbb</h2>
				 ...
				 * script 태그 제거
				 * 
				 * @function ODNF.String.stripScripts
				 * @description 대상문자열에서 script태그를 제거한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.stripScripts('<div>aaa
				 *          <h2>bbb</h2>
				 ...
				 * url 여부 확인
				 * 
				 * @function ODNF.String.isURL
				 * @description 대상문자열에서 script태그를 제거한다.
				 * @param {String}
				 *            value 대상 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.isURL('http://ODNF.standardchar'); 
				 * > aaabbb
				 */
                isURL: function(str) {
				 ...
				 *            value 입력값
				 * @returns {String} 문자열
				 * @example ODNF.String.sprintf("변수의 값은 : %05d", 33); > 변수의 값은 :
				 *          00033
				 * @example ODNF.String.sprintf("변수의 값은 : %05d, %010d, %d", 33,
				 ...
				 * 특수문자 제거
				 * 
				 * @function ODNF.String.removeSpecialChar
				 * @description 입력받은 문자열에 포함된 특수문자를 제거한다.
				 * @param {String}
				 *            orgStr 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.removeSpecialChar("@!#213423!@#"); >
				 *          "213423"
				 */
				 ...
				 * 전화번호 형식 변환
				 * 
				 * @function ODNF.String.cnvTelNo
				 * @description 입력받은 전화번호에 - 추가.
				 * @param {String}
				 *            orgStr 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.cnvTelNo("01012348899"); > 010-1234-8899
				 */
				 ...
				 * 숫자 자리수 3자리 마다 콤마
				 * 
				 * @function ODNF.String.numberWithCommas
				 * @description 숫자 자리수 3자리 마다 콤마
				 * @param {String}
				 *            orgStr 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.numberWithCommas("123654"); > 123,654
				 */
				 ...
				 * 숫자 콤마 제거
				 * 
				 * @function ODNF.String.removeCommas
				 * @description 숫자 콤마 제거.
				 * @param {String}
				 *            orgStr 문자열
				 * @returns {String} 문자열
				 * @example ODNF.String.removeCommas("123,654"); > 123654
				 */
				 ...
				 * 
				 * @function ODNF.String.inputDateFormat
				 * @description 날짜 정합성 비교 및 문자열 형식으로 날짜 변환 
				 * @param {String}
				 *            orgStr 문자열
				 * @returns {String} true 문자열, false ""
				 * @example ODNF.String.inputDateFormat("2222/22/22"); > ""
				 */
				 ...
				 * 문자열을 날짜 형식 수정
				 * 
				 * @function ODNF.String.outputDateFormat
				 * @description 문자열을 날짜 형식 수정 
				 * @param {String}
				 *            orgStr 문자열
				 * @returns {String} true 문자열, false ""
				 * @example ODNF.String.outputDateFormat("1888/05/25"); > "18880525"
				 */
        ...
        _ODNF.Valid = {
				 ...
				 * 전화번호 검증
				 * 
				 * @function ODNF.Valid.chkTelNo
				 * @description 입력받은 전화번호검증.
				 * @param {String}
				 *            str 문자열
				 * @returns {Boolean} 정상전화번호는 true, 비정상전화번호는 false
				 * @example ODNF.Valid.chkTelNo("01012341234"); > true
				 *          "213423"
				 */            		
	        		chkTelNo: function (str){
	        			var regTel = /^(01[016789]{1}|070|02|0[3-9]{1}[0-9]{1})-?[0-9]{3,4}-?[0-9]{4}$/;
	        			if(!regTel.test(str)) {        				
	        				ODNF.alert('올바른 전화번호를 입력하세요.');
	            			return false;
	            		}else {
	            			return true;
	            		}
				 ...
				 * 숫자만 입력
				 * 
				 * @function ODNF.Valid.numkeyCheck
				 * @description 숫자만 입력
				 * @param             
				 * @returns {Boolean} 숫자 true, 비숫자는 false
				 * @example ODNF.Valid.numkeyCheck("01012341234"); > true
				 *          "213423"
				 */ 
				 ...
				 * 숫자만 입력
				 * 
				 * @function ODNF.Valid.onlyNumber
				 * @description 숫자만 입력(영문 제거)
				 * @param             
				 * @returns {Boolean} 숫자 true, 비숫자는 false
				 * @example ODNF.Valid.onlyNumber("01012341234"); > true
				 *          "213423"
				 */
				 ...
				 * 숫자 입력시 한글제거
				 * 
				 * @function ODNF.Valid.removeChar
				 * @description 한글제거
				 * @param             
				 * @returns {Boolean} 숫자 true, 비숫자는 false
				 * @example ODNF.Valid.removeChar("123ㅁㄴㅇ"); > 123
				 */
        	     ...
        	     * 이메일 검증
        	     * 
        	     * @function ODNF.Valid.emailCheck
		 ...
		 * 
		 * @function ODNF.ajax
		 * @description ajax 통신을 위한 공통 함수. 꼭 필요한 경우를 제외하고 ODNF.Tran을 사용한다.
		 * @see ODNF.Tran
		 * @param {Object}
		 *            obj 전송 옵션
		 * @param {Function}
		 ...
		 * 리얼 그리드 기본 레퍼 클래스
		 */
		_ODNF.createSimpleGrid = function(markupId) {
			...
			var GridWrapper = {
				...
				, load : function(data) {
					...
					try {
						...
						if( xmlDoc == null ) {
							ODNF.alert('템플릿 파일을 확인해 주세요. ['+tpl_url+']');
						} else {
					...
					if( readOnly == 'N' || insertable == 'Y' || appendable == 'Y' ) {
						...
						if( appendable == 'Y' ) {
							...
							$('#'+ 'grid-btn-add-' + markupId).click(function() {
								var targetGrid = ODNF.getGridById(markupId);
								if( targetGrid.isDataBinded()  ) {
									targetGrid.gridView.beginAppendRow();
									if( ODNF.onClickNewButton ) {
										ODNF.onClickNewButton(targetGrid);
									}
								}
							})
						}
				...
				, getChangedData : function() {
					...
					for( var i = 0; i < cnt; i++ ) {
						...
						if( sts == 'created' ) {
							...
							if( !ODNF.Object.isEmpty(GridWrapper.keyData) ) {
...
//					var currState = GridWrapper.dataProvider.getRowState(currRow);
			...
			ODNF.gridMap[markupId] = GridWrapper;
		...
		_ODNF.formDatasCommit = function() {
			
			for( var frmId in ODNF.formDatas ) {
				var formDataArray = $('#' + frmId).serializeArray();
				ODNF.formDatas[frmId] = formDataArray;
			}
		}
		
		_ODNF.formDatasRollback = function() {
			
			for( var frmId in ODNF.formDatas ) {
				
				var dataArray = ODNF.formDatas[frmId];
		...
		_ODNF.updateCurrentRow = function(gridId, datas) {
			
			var gird = ODNF.getGridById(gridId);
		...
		_ODNF.setFormData = function(frmId) {
		...
		_ODNF.clearRowStates = function() {
			...
			/* Form 데이터 커밋 */
			ODNF.formDatasCommit();
			
			changeSaveBtnSts();
		}
		
		_ODNF.isGridsChanged = function() {
			/* 그리드 데이터 변경 여부 */
			for( var key in targetGrids ) {
			...
			/* Form 데이터 변경여부*/
			for( var frmId in ODNF.formDatas ) {
				var prevDatas = ODNF.formDatas[frmId];
		...
		_ODNF.gridValid = function(callback, rollbackAction) {
		...
		_ODNF.getGridById = function(gridId) {
			
			for( var key in ODNF.gridMap ) {
				var grid = ODNF.gridMap[key];
		...
		/**
		 * 그리드 콤보 세팅 함수
		 * gridId :: 세팅할 그리드 ID ex)donghoGrid = ODNF.createSimpleGrid('dongho-grid')로 선언된 donghoGrid
		 * col :: 그리드의 컬럼 ID ex) "useYn"
		 * url :: "commCombo" : 공통코드 , "customCombo" : 사용자코드
		 * param :: 보낼 파라미터 ex) "sqlId=comm&parm1=A&parm2=B"
		 * 사용방법 :: ODNF.setGridCombo(donghoGrid, "useYn", "commCombo", "")
		 */
		_ODNF.setGridCombo = function(gridId, col, url, param){
		 ...
		 * @param height
		 */
		_ODNF.gridReSize = function(grid, grdId, height) {
		...
		_ODNF.excelUpload = {
		    ...
		    , process_wb : function (wb,gridId,sqlId) {
		        var output = "";
		     
		        output = ODNF.excelUpload.to_json(wb);
		        
		        //alert(output.length);
		        
		        /*
		            여기서 엑셀 결과 json의 키값을 기존 그리드 컬럼값으로 교체 혹은 재생성? 하면 기존 그리드에 데이터만 사용 가능할듯
		            강제로 키 명칭 변경
		        */
		                
		        var str = JSON.stringify(output);
		                
		        for(i=0; i<gridId.dataProvider.getFieldNames().length; i++){
		        	str = str.replace(new RegExp('"'+String.fromCharCode(65+i)+'":', "g"), '\"'+gridId.dataProvider.getOrgFieldName(i)+'\":');
		        ...
		        if (sheetNames.length > 0) {
		            ...
		            if (colsObj) {
		            	if (sqlId != ""){
			                ...
			                obj.type = 'POST';
			                obj.dataType = 'json';
			                obj.data = JSON.stringify(output);
			                ...
			                // 그리드 출력
			            	ODNF.excelUpload.setFieldsSetColumns(colsObj,gridId);
			                // json 데이터 그리드에 바인딩
			            	gridId.dataProvider.fillJsonData(output, { rows: sheetNames[0], start: 1, fillMode: "insert" });
		            	}
		    ...
		    // json 데이터로 그리드 생성
		    , setFieldsSetColumns : function (colsObj,gridId) {
		        var fields = [];
		        var columns = [];
		        ...
		        //var addFiled = {};
		        //addFiled.fieldName ="aesBirthNo"; 
		        //fields.push(addFiled);
		        
		        //console.log(fields);
		        
		        gridId.dataProvider.setFields(fields);
		        gridId.gridView.setColumns(columns)
